...
public class InfoUserActivity extends AppCompatActivity {
    ...
    // para corregir todos los errores debemos crezr lz zctividad
    // activity_info_user.xml
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // aqui mostramos la referencia del metodo
    ...
    // procedemos a crear el metodo par visualizar las lista de los seguidores
    ...
    private void mostrarDatosBasicos(String loginName){
        ...
        // agregamos para mostrar las lista de seguidores
